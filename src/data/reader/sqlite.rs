...
impl <'d> DBReader <'d>{
    ...
    fn get_set_roms<S>(&self, game_name: S, rom_mode: RomsetMode) -> Result<Vec<DataFile>> where S: AsRef<str> + rusqlite::ToSql {
